...
function getHistoryByType(type, props) {
  switch (type) {
    ...
    default:
      return (0, _createHashHistory2.default)({
        basename: props.basename,
...
function BindRouter(_ref) {
  ...
  if (children) {
    inner = typeof children === "function" ? children(sagaModel) : children;
      ...
      inner = _react2.default.createElement(component, {
        sagaModel: sagaModel,
        history: history,
...
function RouterProvider(props) {
  (0, _invariant2.default)(props.children || props.component, "RouterProvider: children or component should be defined");
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(BindRouter, { children: children, sagaModel: sagaModel, component: component })
  );
}
