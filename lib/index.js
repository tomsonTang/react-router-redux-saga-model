...
function RouterProvider(props) {
  ...
  var sagaModel = new _reduxSagaModel.SagaModel({ initialState: initialState, initialReducer: initialReducer, initialMiddleware: initialMiddleware, initialModels: initialModels, history: history });
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(BindRouter, { children: children, history: history, sagaModel: sagaModel })
  );
};
